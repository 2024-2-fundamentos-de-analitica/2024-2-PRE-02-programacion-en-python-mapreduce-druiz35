...
def create_marker(output_directory):
    """Create Marker"""
    with open(f"{output_directory}/_SUCCESS", "x") as f:
        f.write("")
...
def run_job(input_directory, output_directory):
    ...
    shuffled_and_sorted = shuffle_and_sort(mapped)
    results = reducer(shuffled_and_sorted)
    create_ouptput_directory(output_directory)
    save_output(output_directory, results)
